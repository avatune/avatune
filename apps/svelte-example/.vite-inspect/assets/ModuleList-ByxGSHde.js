...
import {
  DurationDisplay_default,
  NumberWithUnit_default,
  useOptionsStore,
} from './options-D_MMddT_.js'
var ByteSizeDisplay_vue_vue_type_script_setup_true_lang_default =
...
var ByteSizeDisplay_default =
  ByteSizeDisplay_vue_vue_type_script_setup_true_lang_default
var FileIcon_vue_vue_type_script_setup_true_lang_default =
  /* @__PURE__ */ defineComponent({
    __name: 'FileIcon',
    props: { filename: {} },
    setup(__props) {
          ...
          createElementBlock(
            'div',
            {
              ...
              class: normalizeClass([
                ...
                unref(isDark)
                  ? ''
                  : 'brightness-60 hue-rotate-180 invert-100 saturate-200',
              ]),
            },
            null,
            2,
        ...
        if (reset.rects)
          rects =
            reset.rects === true
              ...
              : reset.rects
        ;({ x: x$2, y: y$2 } = computeCoordsFromPlacement(
          rects,
          statefulPlacement,
          rtl,
        ))
...
function g$1(t) {
  ...
  return (
    /auto|scroll|overlay|hidden|clip/.test(e + i$1 + n$2) &&
    !['inline', 'contents'].includes(r$1)
  )
}
function m$1(t) {
...
function E$1(t, e, o$1, i$1) {
  ...
  let h$3 =
      (c$2.left +
        ((a$1 &&
          (null == (r$1 = u$1.visualViewport) ? void 0 : r$1.offsetLeft)) ||
          0)) /
      f$1.x,
    p$1 =
      (c$2.top +
        ((a$1 &&
          (null == (l$1 = u$1.visualViewport) ? void 0 : l$1.offsetTop)) ||
          0)) /
      f$1.y,
    g$2 = c$2.width / f$1.x,
...
function R(t) {
  return ((h$2(t) ? t.ownerDocument : t.document) || window.document)
    .documentElement
}
function T(t) {
  return d$1(t)
...
function D(t, e) {
  ...
  const i$1 = W(t),
    ...
    l$1 = n$1(i$1)
  return r$1
    ? e.concat(l$1, l$1.visualViewport || [], g$1(i$1) ? i$1 : [])
    : e.concat(i$1, D(i$1))
}
    ...
    ? rectToClientRect(
        (function (t, e$1) {
          ...
          if (r$1) {
            ...
            const t$1 = x$1()
            ;(t$1 || (!t$1 && 'fixed' === e$1)) &&
              ((s$1 = r$1.offsetLeft), (f$1 = r$1.offsetTop))
          }
          return {
            width: l$2,
            height: c$2,
    ...
    : d$1(i$1)
      ...
      : rectToClientRect(
          (function (t) {
            ...
            return (
              'rtl' === o(i$2).direction &&
                (s$1 += r(e$1.clientWidth, i$2.clientWidth) - l$2),
              {
                width: l$2,
                height: c$2,
                x: s$1,
...
function H$1(t) {
  ...
  return i$1 &&
    ('html' === s(i$1) ||
      ('body' === s(i$1) && 'static' === o(i$1).position && !y$1(i$1)))
    ? e
    : i$1 ||
        (function (t$1) {
          let e$1 = F(t$1)
...
const P = {
  ...
  convertOffsetParentRelativeRectToViewportRelativeRect: function (t) {
    ...
    if (
      (i$1 || (!i$1 && 'fixed' !== o$1)) &&
      (('body' !== s(n$2) || g$1(r$1)) && (l$1 = T(n$2)), a(n$2))
    ) {
      const t$1 = E$1(n$2)
      ;(c$2 = L(n$2)),
        (f$1.x = t$1.x + n$2.clientLeft),
        (f$1.y = t$1.y + n$2.clientTop)
    }
    return {
      width: e.width * c$2.x,
...
function Ze(e) {
  ...
  let o$1 = h$1.themes[e] || {}
  do
    o$1.$extend && !o$1.$resetCss
      ? (t.push(o$1.$extend), (o$1 = h$1.themes[o$1.$extend] || {}))
      : (o$1 = null)
  while (o$1)
...
const Te = ['auto', 'top', 'bottom', 'left', 'right'].reduce(
    ...
    defineComponent({
      ...
      methods: {
        show({ event: e = null, skipDelay: t = !1, force: o$1 = !1 } = {}) {
          var i$1, s$1
          ;((i$1 = this.parentPopper) != null &&
            i$1.lockedChild &&
            this.parentPopper.lockedChild !== this) ||
            ((this.pendingHide = !1),
            (o$1 || !this.disabled) &&
              (((s$1 = this.parentPopper) == null
                ? void 0
                : s$1.lockedChild) === this &&
        ...
        hide({ event: e = null, skipDelay: t = !1 } = {}) {
          ...
          if (!this.$_hideInProgress) {
            ...
            ;((o$1 = this.parentPopper) == null ? void 0 : o$1.lockedChild) ===
              ...
              size({
                ...
                apply: ({ availableWidth: i$1, availableHeight: s$1 }) => {
                  ;(this.$_innerNode.style.maxWidth =
                    i$1 != null ? `${i$1}px` : null),
                    (this.$_innerNode.style.maxHeight =
                      s$1 != null ? `${s$1}px` : null)
                },
              }),
            ))
        ...
        async $_applyHide(e = !1) {
          ...
          for (const o$1 of re(this.theme)) {
            ...
            de(i$1, this),
              i$1.length === 0 &&
                document.body.classList.remove(`v-popper--some-open--${o$1}`)
          }
          g === this && (g = null),
            (this.isShown = !1),
            this.$_applyAttrsToTarget({
        ...
        $_addEventListeners() {
          const e = (o$1) => {
            ;(this.isShown && !this.$_hideInProgress) ||
              ((o$1.usedByTooltip = !0),
              !this.$_preventShow && this.show({ event: o$1 }))
          }
        ...
        $_registerEventListeners(e, t, o$1) {
          this.$_events.push({
            ...
            e.forEach((i$1) =>
              i$1.addEventListener(t, o$1, $ ? { passive: !0 } : void 0),
            )
        },
        ...
        $_removeEventListeners(e) {
          ...
          this.$_events.forEach((o$1) => {
            ...
            !e || e === s$1
              ? i$1.forEach((p$1) => p$1.removeEventListener(s$1, r$1))
              : t.push(o$1)
          }),
            (this.$_events = t)
        },
...
function Pe(e, t) {
  ...
  for (let i$1 = d.length - 1; i$1 >= 0; i$1--) {
    const s$1 = d[i$1]
    try {
      const r$1 = (s$1.containsGlobalTarget =
        s$1.mouseDownContains || s$1.popperNode().contains(e.target))
      ;(s$1.pendingHide = !1),
        requestAnimationFrame(() => {
          if (((s$1.pendingHide = !1), !o$1[s$1.randomId] && ce(s$1, r$1, e))) {
            if (
              (s$1.$_handleGlobalClose(e, t),
              !e.closeAllPopover && e.closePopover && r$1)
            ) {
...
function C(e, t, o$1, i$1, s$1, r$1, p$1, a$1) {
  const l$1 =
      ((p$1 - s$1) * (t - r$1) - (a$1 - r$1) * (e - s$1)) /
      ((a$1 - r$1) * (o$1 - e) - (p$1 - s$1) * (i$1 - t)),
    u$1 =
      ((o$1 - e) * (t - r$1) - (i$1 - t) * (e - s$1)) /
      ((a$1 - r$1) * (o$1 - e) - (p$1 - s$1) * (i$1 - t))
...
popScopeId()
const at = /* @__PURE__ */ rt(
  (e, t, o$1, i$1, s$1, r$1) => (openBlock(), createBlock('div', pt)),
)
E.render = at
...
const Z = (e = 'theme') => ({
  ...
  ut = /* @__PURE__ */ createBaseVNode(
    'div',
    { class: 'v-popper__arrow-outer' },
    null,
    -1,
  ),
  ft = /* @__PURE__ */ createBaseVNode(
    'div',
  ...
  return (
    ...
    createElementBlock(
      'div',
      {
        ...
        onKeyup:
          t[2] ||
          (t[2] = withKeys((a$1) => e.autoHide && e.$emit('hide'), ['esc'])),
      },
      [
        createBaseVNode('div', {
  ...
  return (
    ...
    createBlock(
      ...
      mergeProps({ ref: 'popper' }, e.$props, {
        ...
        'onUpdate:shown':
          t[2] || (t[2] = (l$1) => e.$emit('update:shown', l$1)),
    ...
    methods: {
      fetchContent(e) {
        if (
          ...
          o$1.then
            ? o$1.then((i$1) => this.onResult(t, i$1))
            : this.onResult(t, o$1)
        }
      },
      onResult(e, t) {
...
function me(e, { value: t, modifiers: o$1 }) {
  ...
  if (!i$1.content || S(i$1.theme || 'tooltip', 'disabled')) He(e)
    ...
    let s$1
    e.$_popper
      ? ((s$1 = e.$_popper), (s$1.options.value = i$1))
      : (s$1 = bt(e, t, o$1)),
      typeof t.shown < 'u' &&
...
function Oe(e) {
  if (e.changedTouches.length === 1) {
    ...
    ;(t.$_vclosepopover_touchPoint = o$1),
...
function Me(e) {
  ...
  if (((t.$_vclosepopover_touch = !1), e.changedTouches.length === 1)) {
    ...
    ;(e.closePopover =
      Math.abs(o$1.screenY - i$1.screenY) < 20 &&
      Math.abs(o$1.screenX - i$1.screenX) < 20),
      (e.closeAllPopover =
        t.$_closePopoverModifiers && !!t.$_closePopoverModifiers.all)
  }
}
...
const ie = {
    ...
    updated(e, { value: t, oldValue: o$1, modifiers: i$1 }) {
      ;(e.$_closePopoverModifiers = i$1),
        t !== o$1 && (typeof t > 'u' || t ? ge(e) : we(e))
    },
    beforeUnmount(e) {
      we(e)
    },
...
function normalizeWindowsPath(input = '') {
  ...
  return input
    .replace(/\\/g, '/')
    .replace(_DRIVE_LETTER_START_RE, (r$1) => r$1.toUpperCase())
}
...
var ModuleId_vue_vue_type_script_setup_true_lang_default =
  /* @__PURE__ */ defineComponent({
    __name: 'ModuleId',
    props: {
      id: {},
    ...
    setup(__props) {
      ...
      const mod = computed(() =>
        payload.modules.find((i$1) => i$1.id === props.id),
      )
            ...
            if (type === 'path') {
              ...
              if (part === ':') {
                if (nodes[index - 1]) {
                  ...
                  nodes[index - 1].props.style.color = getPluginColor(
                    parts[index - 1],
                  )
                }
                _class.push('op50')
...
var ModuleList_vue_vue_type_script_setup_true_lang_default =
  /* @__PURE__ */ defineComponent({
    __name: 'ModuleList',
    props: { modules: {} },
    setup(__props) {
            ...
            createElementBlock('div', _hoisted_1, [
              !_ctx.modules.length
                        ...
                        createElementBlock('div', _hoisted_4, [
                          ...(_cache[0] ||
                            (_cache[0] = [
                              ...
                              createTextVNode(
                                ' first and then refresh this page. ',
                                -1,
                              ),
                            ])),
                        ])),
                ...
                : (openBlock(),
                  createElementBlock(
                    'div',
                    mergeProps({ key: 1 }, unref(containerProps), {
                      class: 'h-full',
                    }),
                    [
                      createBaseVNode(
                              ...
                              return (
                                ...
                                createBlock(
                                  _component_RouterLink,
                                  {
                                    ...
                                    class:
                                      'block border-b border-main px-3 py-2 text-left text-sm font-mono hover:bg-active',
                                    to: {
                                      path: '/module',
                                      query: {
                                        ...unref(route).query,
