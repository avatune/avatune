...
var Container_default = /* @__PURE__ */ __plugin_vue_export_helper_default(
  _sfc_main,
  [['render', _sfc_render]],
)
/**
...
var PluginName_vue_vue_type_script_setup_true_lang_default =
      ...
      function render() {
        ...
        if (parts.length > 1)
          return h('span', [
            h(
              'span',
              { style: { color: getHashColorFromString(parts[0]) } },
              `${parts[0]}:`,
            ),
...
var Badge_vue_vue_type_script_setup_true_lang_default =
  /* @__PURE__ */ defineComponent({
    __name: 'Badge',
    props: {
      text: {},
...
var NavBar_vue_vue_type_script_setup_true_lang_default =
  /* @__PURE__ */ defineComponent({
    __name: 'NavBar',
    setup(__props) {
                    ...
                    [
                      ...
                      createBaseVNode(
                        'button',
                        {
                          ...
                          onClick:
                            _cache[0] ||
                            (_cache[0] = ($event) => unref(toggleDark)()),
                        },
                        [
                          ...(_cache[1] ||
                            (_cache[1] = [
...
var SegmentControl_vue_vue_type_script_setup_true_lang_default =
  /* @__PURE__ */ defineComponent({
                ...
                return (
                  ...
                  createBlock(
                    _component_Badge,
                    {
                      ...
                      as: 'button',
                      onClick: ($event) =>
                        _ctx.$emit('update:modelValue', option.value),
                    },
                    null,
                    8,
...
var SegmentControl_default =
  SegmentControl_vue_vue_type_script_setup_true_lang_default
const _hoisted_1 = { flex: '~ gap-2' }
var QuerySelector_vue_vue_type_script_setup_true_lang_default =
  /* @__PURE__ */ defineComponent({
          ...
          createElementBlock('div', _hoisted_1, [
                ...
                createBlock(
                  _component_SegmentControl,
                  {
                    ...
                    'onUpdate:modelValue':
                      _cache[0] ||
                      (_cache[0] = ($event) =>
                        (unref(payload).query.vite = $event)),
            ...
            createVNode(
              _component_SegmentControl,
              {
                ...
                'onUpdate:modelValue':
                  _cache[1] ||
                  (_cache[1] = ($event) => (unref(payload).query.env = $event)),
...
var QuerySelector_default =
  QuerySelector_vue_vue_type_script_setup_true_lang_default
export {
  Badge_default,
  Container_default,
  NavBar_default,
