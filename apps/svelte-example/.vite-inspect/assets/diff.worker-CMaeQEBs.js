  ...
  function expose(obj, ep = globalThis, allowedOrigins = ['*']) {
    ep.addEventListener('message', function callback(ev) {
      ...
      try {
        const parent = path
          .slice(0, -1)
          .reduce((obj$1, prop) => obj$1[prop], obj)
  ...
  function diffMain(
    ...
    if (typeof opt_deadline == 'undefined')
      if (resolved.diffTimeout <= 0) opt_deadline = Number.MAX_VALUE
        ...
        opt_deadline =
          /* @__PURE__ */ new Date().getTime() + resolved.diffTimeout * 1e3
      ...
      if (diffs[pointer][0] === DIFF_EQUAL) {
        ...
        if (
          ...
          diffs.splice(
            ...
            0,
            createDiff(DIFF_DELETE, lastEquality),
          )
        ...
        if (overlap_length1 >= overlap_length2) {
          if (
            ...
            diffs.splice(
              pointer,
              0,
              createDiff(DIFF_EQUAL, insertion.substring(0, overlap_length1)),
            )
          ...
          diffs.splice(
            pointer,
            0,
            createDiff(DIFF_EQUAL, deletion.substring(0, overlap_length2)),
          )
