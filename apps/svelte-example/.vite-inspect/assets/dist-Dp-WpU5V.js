...
const c = /* @__PURE__ */ (function () {
  class o {
    ...
    serializeObject(t) {
      ...
      if (r$1 !== '[object Object]')
        return this.serializeBuiltInType(
          r$1.length < 10 ? `unknown:${r$1}` : r$1.slice(8, -1),
          t,
        )
    ...
    serializeBuiltInType(t, r$1) {
      ...
      if (typeof r$1?.entries == 'function')
        return this.serializeObjectEntries(t, r$1.entries())
    ...
    serializeObjectEntries(t, r$1) {
      ...
      for (let i = 0; i < e.length; i++) {
        const [a, l$1] = e[i]
        ;(n += `${this.serialize(a, true)}:${this.serialize(l$1)}`),
          i < e.length - 1 && (n += ',')
      }
      return n + '}'
    }
    ...
    $Array(t) {
      ...
      for (let e = 0; e < t.length; e++)
        (r$1 += this.serialize(t[e])), e < t.length - 1 && (r$1 += ',')
      return r$1 + ']'
    }
    $Date(t) {
      try {
...
var k = class {
  ...
  _append(e) {
    typeof e == 'string' && (e = l.fromUtf8(e)),
      this._data.concat(e),
...
var l = class l {
  ...
  static fromUtf8(e) {
    const s = unescape(encodeURIComponent(e)),
      ...
      i = []
    for (let o = 0; o < t; o++)
      i[o >>> 2] |= (s.charCodeAt(o) & 255) << (24 - (o % 4) * 8)
    return new l(i, t)
  }
  toBase64() {
    const e = []
