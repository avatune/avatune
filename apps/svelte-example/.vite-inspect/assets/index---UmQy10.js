    ...
    children: [
      {
        ...
        component: () =>
          __vitePreload(
            () => import('./_...all_-DVz6Qbfk.js'),
            __vite__mapDeps([9, 1, 3]),
            import.meta.url,
          ),
      },
      {
...
var App_vue_vue_type_script_setup_true_lang_default =
  /* @__PURE__ */ defineComponent({
    ...
    async setup(__props) {
      ...
      ;([__temp, __restore] = withAsyncContext(() => payload.init())),
        await __temp,
        __restore()
      return (_ctx, _cache) => {
        ...
        return (
          ...
          createElementBlock('main', _hoisted_1, [
            ...
            createBlock(Suspense, null, {
              fallback: withCtx(() => [
                ...(_cache[0] ||
                  (_cache[0] = [createTextVNode(' Loading... ', -1)])),
              ]),
