...
var NumberWithUnit_vue_vue_type_script_setup_true_lang_default =
...
var NumberWithUnit_default =
  NumberWithUnit_vue_vue_type_script_setup_true_lang_default
var DurationDisplay_vue_vue_type_script_setup_true_lang_default =
  /* @__PURE__ */ defineComponent({
...
var DurationDisplay_default =
  DurationDisplay_vue_vue_type_script_setup_true_lang_default
const useOptionsStore = defineStore('options', () => {
  ...
  function toggleListMode() {
    ...
    view.value.listMode =
      modes[(modes.indexOf(view.value.listMode) + 1) % modes.length]
  }
  return {
    view,
    search,
