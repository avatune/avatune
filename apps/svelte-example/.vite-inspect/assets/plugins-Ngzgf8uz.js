...
var plugins_vue_vue_type_script_setup_true_lang_default =
          ...
          if (!e) nodes.push(h('td'))
            ...
            nodes.push(
              h(
                ...
                [
                  h(PluginName_default, {
                    name: payload.instance.plugins[idx].name,
                  }),
                ],
              ),
            )
                    ...
                    createBaseVNode('table', _hoisted_1, [
                      createBaseVNode('thead', null, [
                        ...
                        createElementBlock(
                          ...
                          null,
                          renderList(
                            unref(payload).instance.environments,
                            (e) => {
                              return (
                                openBlock(),
                                createElementBlock(
                      ...
                      createBaseVNode('tbody', null, [
                        ...
                        createElementBlock(
                          ...
                          null,
                          renderList(
                            unref(payload).instance.plugins,
                            (p, idx) => {
                              return (
                                openBlock(),
                                createElementBlock('tr', { key: idx }, [
                                  (openBlock(),
                                  createBlock(
                                    resolveDynamicComponent(renderRow(idx)),
                                  )),
                                ])
                              )
                            },
