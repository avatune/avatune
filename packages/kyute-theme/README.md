...
This theme uses assets from the [`@avatune/kyute-assets`](../packages/kyute-assets) package.
...
- [CREDITS.md](../packages/kyute-assets/CREDITS.md) - Asset attribution
- Asset package license in [`@avatune/kyute-assets`](../packages/kyute-assets)

## Related Packages

- [`@avatune/kyute-assets`](../packages/kyute-assets) - SVG assets used by this theme
