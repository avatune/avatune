...
import HairFonze from './svg/hair/fonze.svg?svelte'
import HairFull from './svg/hair/full.svg?svelte'
...
import MouthPucker from './svg/mouth/pucker.svg?svelte'
import MouthSad from './svg/mouth/sad.svg?svelte'
...
import NosesPointed from './svg/noses/pointed.svg?svelte'
import NosesRound from './svg/noses/round.svg?svelte'
