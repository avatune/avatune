...
This theme uses assets from the [`@avatune/fatin-verse-assets`](https://github.com/AvatuneAI/avatune/tree/main/packages/assets/fatin-verse-assets) package.
...
- [`@avatune/fatin-verse-assets`](https://github.com/AvatuneAI/avatune/tree/main/packages/assets/fatin-verse-assets) - SVG assets used by this theme
