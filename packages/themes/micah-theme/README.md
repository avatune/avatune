...
This theme uses assets from the [`@avatune/micah-assets`](https://github.com/AvatuneAI/avatune/tree/main/packages/assets/micah-assets) package.
...
- [CREDITS.md](https://github.com/AvatuneAI/avatune/blob/main/packages/assets/micah-assets/CREDITS.md) - Asset attribution
- Asset package license in [`@avatune/micah-assets`](https://github.com/AvatuneAI/avatune/tree/main/packages/assets/micah-assets)

## Related Packages

- [`@avatune/micah-assets`](https://github.com/AvatuneAI/avatune/tree/main/packages/assets/micah-assets) - SVG assets used by this theme
