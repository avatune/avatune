...
[![npm bundle size](https://img.shields.io/npm/unpacked-size/@avatune/micah-theme)](https://www.npmjs.com/package/@avatune/micah-theme)
...
This theme uses assets from the [`@avatune/micah-assets`](https://github.com/avatune/avatune/tree/main/packages/assets/micah-assets) package.
...
- [CREDITS.md](https://github.com/avatune/avatune/blob/main/packages/assets/micah-assets/CREDITS.md) - Asset attribution
- Asset package license in [`@avatune/micah-assets`](https://github.com/avatune/avatune/tree/main/packages/assets/micah-assets)
