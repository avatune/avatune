...
[![npm version](https://img.shields.io/npm/v/@avatune/retro-cartoon-theme)](https://www.npmjs.com/package/@avatune/retro-cartoon-theme)
[![npm bundle size](https://img.shields.io/npm/unpacked-size/@avatune/retro-cartoon-theme)](https://www.npmjs.com/package/@avatune/retro-cartoon-theme)
...
```bash
npm install @avatune/retro-cartoon-theme
```
...
This theme uses assets from the [`@avatune/retro-cartoon-assets`](https://github.com/avatune/avatune/tree/main/packages/assets/retro-cartoon-assets) package.
