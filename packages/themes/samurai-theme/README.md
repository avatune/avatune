# @avatune/samurai-theme

[![npm version](https://img.shields.io/npm/v/@avatune/samurai-theme)](https://www.npmjs.com/package/@avatune/samurai-theme)
[![npm bundle size](https://img.shields.io/npm/unpacked-size/@avatune/samurai-theme)](https://www.npmjs.com/package/@avatune/samurai-theme)
...
```bash
npm install @avatune/samurai-theme
```
...
This theme uses assets from the [`@avatune/samurai-assets`](https://github.com/avatune/avatune/tree/main/packages/assets/samurai-assets) package.
