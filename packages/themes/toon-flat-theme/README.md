...
[![npm version](https://img.shields.io/npm/v/@avatune/toon-flat-theme)](https://www.npmjs.com/package/@avatune/toon-flat-theme)
[![npm bundle size](https://img.shields.io/npm/unpacked-size/@avatune/toon-flat-theme)](https://www.npmjs.com/package/@avatune/toon-flat-theme)
...
```bash
npm install @avatune/toon-flat-theme
```
...
This theme uses assets from the [`@avatune/toon-flat-assets`](https://github.com/avatune/avatune/tree/main/packages/assets/toon-flat-assets) package.
